...
export const createTaskSchema = (isRepresentative = false) =>
    z.object({
        assigneeId: isRepresentative ? z.string().optional() : z.string().min(1, 'Это поле обязательно'),
...
export type CreateTaskFormValues = z.infer<ReturnType<typeof createTaskSchema>>;
